        ...
        <div className="container">
          ...
          <div className="row pd-top-92">
            ...
            <div className="col-xl-3 col-sm-6">
              <div className="single-contact-info">
                <p>
                  <i className="fa fa-envelope" /> Have any Question ?
                </p>
                <h5> be1newinner@gmail.com </h5> <h5> info@shipsar.in </h5>
              </div>
            </div>
            <div className="col-xl-3 col-sm-6">
              <div className="single-contact-info">
                <p>
                  <i className="fa fa-phone" /> Address
                </p>
                <h5> Saket, Near Metro, </h5>
                <h5> Delhi - 62, India </h5>
              </div>
            </div>
          </div>
        </div>
