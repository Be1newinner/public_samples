            ...
            <div className="row ">
              <div className="col-xl-9 col-lg-8">
                <div className="property-details-slider">
                  <div className="item">
                    <div className="thumb">
                      <img src={"/assets/img/news/19.png"} alt={imagealt} />
                    </div>
                  </div>
                </div>
                ...
                <div className="widget widget-owner-info mt-lg-0 mt-5">
                  <div className="owner-info text-center">
                    ...
                    <div className="details">
                      ...
                      <p className="reviews">
                        <i className="fa fa-star" /> <span> 4.8 </span> 70
                        Review
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="contact-info">
                    ...
                    <div className="media">
                      ...
                      <div className="media-body">
                        <p> Phone </p> <span> +00 111 222 333 </span>
                      </div>
                    </div>
                    <div className="media mb-0">
                      ...
                      <div className="media-body">
                        <p> Email </p> <span> info @example.com </span>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="row pd-top-90">
            <div className="col-lg-9">
                ...
                <div className="row">
                  ...
                  <div className="col-md-3 col-sm-6">
                    <div className="single-property-info">
                      <h5> Parking </h5>
                      <p>
                        <i className="fa fa-car" /> 01 Indoor
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="row">
                  ...
                  <div className="col-sm-4">
                    <ul className="rld-list-style mb-3 mb-sm-0">
                      ...
                      <li>
                        <i className="fa fa-check" /> 24 x7 Security
                      </li>
                      <li>
              ...
              <div className="property-news-single-card border-bottom-yellow">
                <h4> Floor Plan </h4>
                <div className="thumb">
                  <img src={"/assets/img/others/10.png"} alt={imagealt} />
                </div>
              </div>
                ...
                <div className="row">
                  <div className="col-md-3 col-sm-6">
                    <div className="single-floor-list media">
                      ...
                      <div className="media-body">
                        <h6> Living Room </h6> <p> 20 x 16 sq feet </p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-3 col-sm-6">
                    <div className="single-floor-list media">
                      ...
                      <div className="media-body">
                        <h6> Garage </h6> <p> 20 x 16 sq feet </p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-3 col-sm-6">
                    <div className="single-floor-list media">
                      ...
                      <div className="media-body">
                        <h6> Dining Area </h6> <p> 20 x 16 sq feet </p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-3 col-sm-6">
                  ...
                  <div className="col-md-3 col-sm-6">
                    <div className="single-floor-list media">
                      ...
                      <div className="media-body">
                        <h6> Bedroom </h6> <p> 20 x 16 sq feet </p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-3 col-sm-6">
                    <div className="single-floor-list media">
                      ...
                      <div className="media-body">
                        <h6> Bathroom </h6> <p> 20 x 16 sq feet </p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-3 col-sm-6">
                    <div className="single-floor-list media">
                      ...
                      <div className="media-body">
                        <h6> Gym Area </h6> <p> 20 x 16 sq feet </p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-3 col-sm-6">
