            ...
            <div className="col-xl-9 col-lg-10">
              ...
              <div className="row">
                ...
                <div className="col-7 text-right add-property-btn-wrap">
                  <a className="btn btn-yellow mr-md-3" href="#">
                    Sell
                  </a>
              ...
              <div className="row pd-top-100">
                <div className="col-md-4">
                  <div className="section-title">
                    <h4>
                      <img src={"/assets/img/icons/28.png"} alt="img" />
                      House Name
                    </h4>
                  </div>
                </div>
              ...
              <div className="row pd-top-80">
                <div className="col-md-4">
                  <div className="section-title">
                    <h4>
                      <img src={"/assets/img/icons/29.png"} alt="img" />
                      Address
                    </h4>
                  </div>
                </div>
              ...
              <div className="row pd-top-80">
                <div className="col-md-4">
                  <div className="section-title">
                    <h4>
                      <img src={"/assets/img/icons/30.png"} alt="img" />
                      Lease
                    </h4>
                  </div>
                </div>
              ...
              <div className="row pd-top-80">
                <div className="col-md-4">
                  <div className="section-title">
                    <h4>
                      <img src={"/assets/img/icons/31.png"} alt="img" />
                      Amenities
                    </h4>
                  </div>
                </div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-sm-4">
                      <ul className="rld-list-style mb-3 mb-sm-0">
                        ...
                        <li>
                          <i className="fa fa-check" /> 24 x7 Sec
                        </li>
                        <li>
